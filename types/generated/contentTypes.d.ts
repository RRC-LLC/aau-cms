...
export interface ApiDoctorDoctor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Undergraduate_Degree: Attribute.String;
    Medical_Degree: Attribute.String;
    Internship: Attribute.String;
    Residency: Attribute.String;
    Fellowship: Attribute.String;
...
export interface ApiHeroImageHeroImage extends Schema.SingleType {
...
export interface ApiLocationLocation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Direction_Link: Attribute.Text & Attribute.Required;
    iFrame_Src: Attribute.Text & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiNursePractitionerNursePractitioner
  extends Schema.CollectionType {
  collectionName: 'nurse_practitioners';
  info: {
    singularName: 'nurse-practitioner';
    pluralName: 'nurse-practitioners';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::nurse-practitioner.nurse-practitioner',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::nurse-practitioner.nurse-practitioner': ApiNursePractitionerNursePractitioner;
